    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-[#040810] text-slate-100">
        ...
        <div className="relative z-10 my-auto py-12">
          ...
          <div className="pt-6 border-t border-slate-800/80 flex items-center gap-6">
            <div>
              ...
              <p className="text-xs text-slate-400">Gratis para empezar</p>
            </div>
      ...
      <div className="lg:col-span-7 flex flex-col justify-center items-center p-6 lg:p-12 relative bg-[#040810]">
        ...
        <div className="w-full max-w-md">
          ...
          <ClerkLoading>
            <div className="w-full bg-[#0A1220] border border-slate-800 rounded-2xl p-8 shadow-2xl animate-pulse flex flex-col items-center justify-center min-h-[460px]">
              <div className="w-8 h-8 border-2 border-sky-400 border-t-transparent rounded-full animate-spin mb-4" />
              <p className="text-xs font-medium text-slate-400">Preparando registro seguro...</p>
            </div>
          </ClerkLoading>
